...
final class BoxIntArrayIndexTests: XCTestCase {
    ...
    func testInt8() {
        ...
        for _ in 0..<25 {
            ...
            let sz = box.setIntArray(arr, index: index, offset: off, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(sz, arr.count * itemWidth.rawValue)
            
            let arrInt8: [Int8]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt8, arr.map { $0 })
            let arrInt8U: [UInt8]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt8U, arr.map { UInt8(truncatingIfNeeded: $0) })

            let arrInt16: [Int16]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt16, arr.map { Int16(truncatingIfNeeded: $0) })
            let arrInt16U: [UInt16]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt16U, arr.map { UInt16(UInt8(truncatingIfNeeded: $0)) })

            let arrInt32: [Int32]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt32, arr.map { Int32(truncatingIfNeeded: $0) })
            let arrInt32U: [UInt32]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt32U, arr.map { UInt32(UInt8(truncatingIfNeeded: $0)) })

            let arrInt64: [Int64]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
            XCTAssertEqual(arrInt64, arr.map { Int64(truncatingIfNeeded: $0) })
            let arrInt64U: [UInt64]  = box.getIntArray(index: index, offsetWidth: offsetWidth, sizeWidth: sizeWidth, itemWidth: itemWidth)
